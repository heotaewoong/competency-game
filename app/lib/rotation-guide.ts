...
export const rotationGuideTips: RotationGuideTip[] = [
  ...
  },
  {
    ...
    steps: '눈금 수 1·2·3·4 확인 → 짧은 방향 → 180°만 LR+UD로 압축.',
    example: 'L135 = L45×3 / 180° = LR→UD',
  },
  {
    id: 'mirror-axis',
    title: '축 반전 2상태',
  ...
  },
  {
    ...
    title: '대각선 반전 2상태',
    badge: '샌드위치',
    criterion: '↗ 또는 ↘ 대각선을 접는 선으로 삼은 거울상인지 봅니다.',
    mistake: 'P형·b형 등 시작 글자에 따라 네 개의 별도 수학적 변환이라고 중복해서 외우는 것.',
    steps: 'L45 → LR 또는 UD → R45. 가운데 반전만 두 축에 따라 달라집니다.',
    example: 'L45→LR→R45 = L45→L45→LR / L45→UD→R45 = L45→L45→UD',
  },
  {
    id: 'order-minimum',
    title: '순서·최소화',
