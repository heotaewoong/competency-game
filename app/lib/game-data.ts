...
export const games: GameMeta[] = [
  ...
  { id:'rps', no:'02', title:'가위바위보', shortTitle:'가위바위보', skill:'인지능력', time:'2023 공개 약 3분 · 2024 자료 4분 · 초대 우선', mark:'✊', tone:'blue', rule:'물음표 위치에 따라 모든 라운드에서 내가 이기는 관계를 완성합니다.', input:'← · ↓ · →', focus:'관점 전환', rounds:'내 패 → 상대 패 → 혼합', difficulty:'하' },
  ...
  { id:'mouse', no:'09', title:'고양이 술래잡기', shortTitle:'고양이', skill:'작업기억·메타인지', time:'2023 공개 약 4분 · 2024 자료 4분 · 초대 우선', mark:'⌗', tone:'red', rule:'6×6 격자의 생쥐 위치를 기억한 뒤 빨강·파랑 고양이가 찾았는지 확신도와 함께 판단합니다.', input:'놓쳤다 · 찾았다 · 확신도', focus:'위치기억·확신 판단', rounds:'생쥐 → 고양이 → 빨강 → 파랑', difficulty:'중' },
];
